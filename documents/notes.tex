...
\subsubsection{Injection dei dati}
 ...
 \begin{itemize}
     \item Metodi di ingestione "seekable-stream" supervisionati come Kafka e Kinesis . Con questi metodi, Druid esegue il commit degli offset del flusso nel proprio archivio di metadati insieme ai metadati del segmento, nella stessa transazione, in qyesti casi è possibile andare ad effettuare operazioni di {rollup}\ref{subsection:rollup} sui dati grezzi;
