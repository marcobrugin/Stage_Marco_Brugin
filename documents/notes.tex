...
\begin{lstlisting}
kubectl apply -f druid-configmap.yaml
kubectl apply -f druid-historical.yaml
kubectl apply -f druid-broker.yaml
kubectl apply -f druid-coordinator.yaml
kubectl apply -f druid-service.yaml
\end{lstlisting}
