...
Ogni \textit{datasources} può contenere.
\subsection{Casi d'uso}
...
A differenza di altri databse di serie temporali, \textbf{Druid} fornisce una serie di funzionalità di ricerca e parrtizionamento che gli permette di eseguire query molto velocemente.
\subsection{Operazioni OLAP}
