...
Dalla seguente sperimentazione si evince una chiara superiorità di \textbf{Apache Druid} su un comune database relazione come \textbf{PostgreSQL}, in particolare nell'esecuzione di query che coninvolgono raggrupamenti, anche su intervalli temporali (ora, giorno, anno).
