...
\subsubsection{Confronto tra Apache Druid cone senza rollup e  Postgres}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.5\textwidth]{images/test_rollup.png}
...
\centering
 & \centering Apache Druid con rollup[s] & \centering Apache Druid senza rollup [s] & \centering PostgreSQL [s] \\\hline 
  \centering
  query1 &  \centering 0.4  & \centering 0.5 & \centering 0.8 \\ \hline
  \centering query2 &  \centering 0.4 & \centering 0.55 & \centering 1.1 \\ \hline
 \centering
  query3 &  \centering 0.57   & \centering 0.77  & \centering 1.5 \\ \hline
 \centering
  query4 &  \centering 0.54   & \centering 0.7  & \centering 1.6 \\ \hline
  \end{tblr}
\end{center}
\paragraph{Conclusioni}
Come riportato dal tabella sovrastante, le misure effettuate sul datasource con \textbf{rollup} sono migliori rispetto a quelle effettuate senza \textbf{rollup}, questo perchè grazie a tale funzionalità si riduce il numero di record da processare. Inoltre si può ancora sottolineare il divario con i database relazionali come \textbf{PostgreSQL}.
